...
- V1.3.10 本地全量包已先行构建：ZIP 与独立解压目录均为 `5256` 个文件，全量包约 `361.2 MB`，SHA-256 为 `8D66701403FF7E132D82C9AB012242A48A7E9CFDDAA8EB379888781C16915A7F`；从 ZIP 解压的 EXE 可持续运行，包内存在完整包名和兼容入口模块，且未产生新的核心故障日志。
