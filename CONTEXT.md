...
- 已从急用包清除 47 个污染文件并重新压缩，最终包 `output/CanalHydraulicCalc-V1.3.11-急用.zip` 为 393,219,128 字节，SHA-256 `746D80441F8785EBE735011E744476902F06EADEDF4158EFE445C5D7F1DC5146`；从最终 ZIP 重新解压后，在仅保留 Windows 系统目录的 `PATH` 下持续启动 12 秒通过。构建脚本现对主程序和更新助手统一隔离 Codex 原生依赖路径。
- GitHub V1.3.11 原故障资产已用修正版精确替换；通用补丁重建为 106,375,443 字节，SHA-256 `4FA30D70C28AAB2B8590B293C1BE7ACBB29876E0631B1DB70D92160C68EFCC61`，覆盖 V1.3.0+。正式 Gist 已回读为 V1.3.11，完整包/补丁哈希与远端资产字节数一致；补丁超过 Gitee 100MB 上限，未上传 Gitee。
