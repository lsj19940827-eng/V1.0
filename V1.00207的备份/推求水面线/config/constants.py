...
INPUT_COLUMNS = [
    ...
    {"id": "name", "text": "建筑物名称", "width": 80, "editable": True},
    {"id": "structure_type", "text": "结构形式", "width": 80, "editable": True, "type": "combobox"},
    {"id": "in_out", "text": "进出口判断", "width": 80, "editable": True},  # 允许用户手动修改
    {"id": "ip_number", "text": "IP", "width": 130, "editable": True},  # 允许用户手动修改
    {"id": "x", "text": "X", "width": 120, "editable": True, "type": "float"},
    {"id": "y", "text": "Y", "width": 120, "editable": True, "type": "float"},
    {"id": "turn_radius", "text": "转弯半径", "width": 80, "editable": True, "type": "float"},
]
...
GEOMETRY_RESULT_COLUMNS = [
    ...
    {"id": "straight_distance", "text": "IP直线间距", "width": 90},
    {"id": "station_ip", "text": "IP点桩号", "width": 140},  # 加宽以容纳格式如"南支15+020.073"
    {"id": "station_BC", "text": "弯前BC", "width": 140},
    {"id": "station_MC", "text": "里程MC", "width": 140},
    {"id": "station_EC", "text": "弯末EC", "width": 140},
    {"id": "check_pre_curve", "text": "复核弯前长度", "width": 100},   # L72-J72 检查起弯点是否超过上一IP
    {"id": "check_post_curve", "text": "复核弯后长度", "width": 100},  # L73-J72 检查出弯点是否超过下一IP
    {"id": "check_total_length", "text": "复核总长度", "width": 100},  # L72-J71-J72 夹直线长度
]
...
ELEVATION_COLUMNS = [
    ...
    {"id": "bottom_elevation", "text": "底高程", "width": 80},
]
...
# 默认值
# ============================================================
DEFAULT_ROUGHNESS = 0.014       # 默认糙率
DEFAULT_TURN_RADIUS = 100.0     # 默认转弯半径 (m)
DEFAULT_GATE_HEAD_LOSS = 0.2    # 默认过闸水头损失 (m)，用于分水闸/分水口
