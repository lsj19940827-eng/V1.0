...
class ChannelNode:
    ...
    bottom_elevation: float = 0.0               # 底高程（m）
...
class ProjectSettings:
    ...
    roughness: float = 0.014                    # 糙率 n（默认0.014）
    
    # ========== 渐变段设置 ==========
    transition_inlet_form: str = "曲线形反弯扭曲面"   # 进口渐变段形式
    transition_outlet_form: str = "曲线形反弯扭曲面"  # 出口渐变段形式
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "转弯半径": self.turn_radius,
            "糙率": self.roughness,
            "进口渐变段形式": self.transition_inlet_form,
            "出口渐变段形式": self.transition_outlet_form,
